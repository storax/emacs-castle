...
and source-file directory for your debugger."
  ...
  (gud-def gud-remove-line "clear %d%f:%l"  "\C-d\C-d" "Remove breakpoint at current line")
  (gud-def gud-remove-prompt (call-interactively 'storax/pdb-clear-breakpoint)  "\C-d\C-D" "Remove breakpoint.")
  (gud-def gud-toggle-bp (call-interactively 'storax/pdb-toogle-breakpoint) "\C-d\C-E" "Toggle breakpoint.")
  (gud-def gud-ignore-bp (call-interactively 'storax/pdb-ignore-breakpoint) "\C-d\C-i" "Ignore breakpoint.")
  (gud-def gud-contidion-bp (call-interactively 'storax/pdb-condition-breakpoint) "\C-d\C-C" "Set condition for breakpoint.")
  (gud-def gud-step   "step"         "\C-d\C-s" "Step one source line with display.")
  (gud-def gud-next   "next"         "\C-d\C-n" "Step one line (skip functions).")
  (gud-def gud-cont   "continue"     "\C-d\C-c" "Continue with display.")
  (gud-def gud-finish "return"       "\C-d\C-r" "Finish executing current function.")
  (gud-def gud-up     "up"           "\C-d<" "Up one stack frame.")
  (gud-def gud-down   "down"         "\C-d>" "Down one stack frame.")
  (gud-def gud-until   "until"         "\C-d\C-u" "Execute until higher line number.")
  (gud-def gud-print-prompt (storax/pdb-print-prompt) "\C-d\C-p" "Print prompt.")
  (gud-def gud-jump "jump %l"        "\C-d\C-j" "Set execution address to current line.")
  (gud-def gud-execute-prompt (storax/pdb-execute-prompt) "\C-d\C-e" "Execute Python statement.")
  ;; (setq comint-prompt-regexp "^(.*pdb[+]?) *")
  (gud-def gud-goto-break (call-interactively 'storax/pdb-goto-breakpoint) "\C-d\C-g" "Goto breakpoint.")
